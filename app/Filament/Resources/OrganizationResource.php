    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\Tabs::make('Organization Settings')
                    ->tabs([
                        ...
                        Forms\Components\Tabs\Tab::make('Brand & Identity')
                            ...
                            ->badge('Header & Brand')
                            ->schema([
                                Forms\Components\Section::make('Company Name & Typography')
                                    ->description('Set business name, visibility toggle, and brand font style.')
                                    ->schema([
                                ...
                                Forms\Components\Section::make('Tagline & SEO')
                                    ->description('Short business statement and site-wide metadata.')
                                    ->schema([
                                        Forms\Components\Grid::make(2)
                                            ->schema([
                        ...
                        Forms\Components\Tabs\Tab::make('Header & Navigation')
                            ->icon('heroicon-m-bars-3')
                            ->badge('Navbar Links')
                            ->schema([
                                Forms\Components\Section::make('Header Bar & Action CTA')
                                    ->description('Control top navbar logo and primary action button.')
                                    ->schema([
                                        Forms\Components\Grid::make(2)
                                            ->schema([
                                    ...
                                    ->schema([
                                        Forms\Components\Repeater::make('theme.nav_items')
                                            ...
                                            ->afterStateHydrated(function (Forms\Components\Repeater $component, $state) {
                                                if (empty($state)) {
                                                    $component->state(Organization::defaultNavItems());
                                                }
                                            })
                                            ->schema([
                        ...
                        Forms\Components\Tabs\Tab::make('Contact & Location')
                            ...
                            ->schema([
                                Forms\Components\Section::make('Postal & Physical Location')
                                    ->schema([
                                        Forms\Components\Grid::make(2)
                                            ->schema([
                                ...
                                Forms\Components\Section::make('Opening Hours & Quick Contacts')
                                    ->schema([
                                        ...
                                        Forms\Components\Repeater::make('opening_hours')
                                            ...
                                            ->columns(3)
                                            ->minItems(1)
                                            ->addActionLabel('Add Opening Hours Slot'),
                                    ]),
                            ]),
                        ...
                        Forms\Components\Tabs\Tab::make('Footer')
                            ...
                            ->schema([
                                Forms\Components\Section::make('Footer Elements Visibility')
                                    ->description('Toggle individual footer sections ON or OFF across the website.')
                                    ->schema([
                        ...
                        Forms\Components\Tabs\Tab::make('Colors & Fonts')
                            ...
                            ->schema([
                                ...
                                Forms\Components\Section::make('Global Typography Defaults')
                                    ->description('Default display and body fonts for the website.')
                                    ->schema([
                        ...
                        Forms\Components\Tabs\Tab::make('Status & Info')
                            ->icon('heroicon-m-cog-6-tooth')
                            ->schema([
                                Forms\Components\Section::make('Record Status')
                                    ->schema([
        ...
        return $table
            ...
            ->actions([
                ...
                \Filament\Tables\Actions\Action::make('view_site')
                    ...
                    ->color('gray')
                    ->url(fn (Organization $record): string => route('card.home', ['slug' => $record->slug ?: \Illuminate\Support\Str::slug($record->title) ?: 'default']))
                    ->openUrlInNewTab(),
            ])
            ->bulkActions([
