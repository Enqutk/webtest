...
<!-- Mirrored from induyst-demo.pbminfotech.com/html-demo/our-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Aug 2025 05:31:24 GMT -->
<head>
      <meta charset="utf-8">
      <meta http-equiv="x-ua-compatible" content="ie=edge">
      <title>Our History – Induyst HTML Template</title>
   ...
   <body>
      ...
      <div class="page-wrapper">
								...
								<div class="pbmit-header-info ml-auto d-flex align-items-center">
									<div class="pbmit-header-info-inner">
										...
										<div class="pbmit-header-box pbmit-header-box-3">
											<a href="https://induyst-demo.pbminfotech.com/cdn-cgi/l/email-protection#3f5150124d5a4f53467f5a475e524f535a115c5052">						
												<span class="pbmit-header-box-icon">
													<i class="pbmit-induyst-icon pbmit-induyst-icon-mail"></i>
												</span>							
												<span class="pbmit-box-content">
													<span class="pbmit-header-box-title">Email address</span>
													<span class="pbmit-header-box-content"><span class="__cf_email__" data-cfemail="a1cfce8cd3c4d1cdd8e1c4d9c0ccd1cdc48fc2cecc">[email&#160;protected]</span></span>
												</span>
											</a>				
										</div>
									</div>
        ...
        <div class="page-content">
			...
			<!-- History End --> 
			<section class="pbmit-bg-color-light history-section">
				<div class="pbmit-element-timeline-style-2">
					<div class="container p-0">
						<div class="pbmit-heading-subheading text-center">
							<h4 class="pbmit-subtitle">Our History</h4>
							<h2 class="pbmit-title">Essential Features Of <br> Our History.</h2>
						</div>
						<div class="pbmit-timeline-post-items">
							<div class="pbmit-timeline-inner">
								<div class=" col-lg-12 pbmit-ourhistory-type2">
										...
										<div class="col-lg-5 pbmit-ourhistory-right">
											<div class="content">
												...
												<div class="simple-text">
													<p>Launched  operations across multiple key sectors to establishing  strong foundation for  industrial growth and innovation in emerging markets.</p>
												</div>
											</div>
										</div>
										<div class="col-lg-2 pbmit-ourhistory-center">
											<div class="pbmit-history-line"></div>
											<div class="pbmit-history-center-dot"></div>
										</div>
										<div class="col-lg-5 pbmit-ourhistory-left">
											<div class="pbmit-timeline-image">
												<img src="images/history/history-01.jpg" class="img-fluid" alt="2021 - 2022">										
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row pbmit-ourhistory-row">
										<div class="col-lg-5 pbmit-ourhistory-right">
											<div class="content">
												...
												<div class="simple-text">
													<p>Built a skilled and experienced team of dedicated professional committed to delivering reliable, high-quality, and specialized industrial solution.</p>
												</div>
											</div>
										</div>
										<div class="col-lg-2 pbmit-ourhistory-center">
										...
										<div class="col-lg-5 pbmit-ourhistory-left">
											<div class="pbmit-timeline-image">
												<img src="images/history/history-02.jpg" class="img-fluid" alt="2022 - 2023">										
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row pbmit-ourhistory-row">
										<div class="col-lg-5 pbmit-ourhistory-right">
											<div class="content">
												...
												<div class="simple-text">
													<p>Expanded into a major U.S. markets, earning national recognition for leadership, performance excellence &amp; innovation across multiple industrial domains.</p>
												</div>
											</div>
										</div>
										<div class="col-lg-2 pbmit-ourhistory-center">
										...
										<div class="col-lg-5 pbmit-ourhistory-left">
											<div class="pbmit-timeline-image">
												<img src="images/history/history-03.jpg" class="img-fluid" alt="2023 - 2024">										
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row pbmit-ourhistory-row">
										<div class="col-lg-5 pbmit-ourhistory-right">
											<div class="content">
												...
												<div class="simple-text">
													<p>Achieved industry-defining milestones, launched advanced technologies &amp; established ourselves  globally trusted leader in  industrial growth.</p>
												</div>
											</div>
										</div>
										<div class="col-lg-2 pbmit-ourhistory-center">
										...
										<div class="col-lg-5 pbmit-ourhistory-left">
											<div class="pbmit-timeline-image">
												<img src="images/history/history-04.jpg" class="img-fluid" alt="2024 - 2025">										
											</div>
										</div>
									</div>
								</div>
			...
			<section>
				<div class="container">
					<div class="swiper-slider client-style-area" data-autoplay="true" data-loop="true" data-dots="false" data-arrows="false" data-columns="5" data-margin="0" data-effect="slide">
						<div class="swiper-wrapper">
							<!-- Slide1 -->
				...
				<div class="pbmit-footer-contact-area">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 col-lg-4 pbmit-footer-contact-box">
								<span><a href="https://induyst-demo.pbminfotech.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1a7975746e7b796e5a7f627b776a767f34797577">[email&#160;protected]</a></span>
							</div>
							<div class="col-md-12 col-lg-4 pbmit-footer-contact-box">
   ...
   <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'96c4dab4fc0bf7f3',t:'MTc1NDcxNzM1MS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='../cdn-cgi/challenge-platform/h/b/scripts/jsd/8359bcf47b68/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"96c4dab4fc0bf7f3","version":"2025.7.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"125856bf84ab44059737e93b01aa0fef","b":1}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from induyst-demo.pbminfotech.com/html-demo/our-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Aug 2025 05:31:29 GMT -->
</html>