...
<!-- Mirrored from induyst-demo.pbminfotech.com/html-demo/portfolio-m-grid-wide.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Aug 2025 05:32:07 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>M Grid Wide – Induyst HTML Template</title>
								...
								<div class="pbmit-header-info ml-auto d-flex align-items-center">
									<div class="pbmit-header-info-inner">
										...
										<div class="pbmit-header-box pbmit-header-box-3">
											<a href="https://induyst-demo.pbminfotech.com/cdn-cgi/l/email-protection#593736742b3c293520193c21383429353c773a3634">						
												<span class="pbmit-header-box-icon">
													<i class="pbmit-induyst-icon pbmit-induyst-icon-mail"></i>
												</span>							
												<span class="pbmit-box-content">
													<span class="pbmit-header-box-title">Email address</span>
													<span class="pbmit-header-box-content"><span class="__cf_email__" data-cfemail="adc3c280dfc8ddc1d4edc8d5ccc0ddc1c883cec2c0">[email&#160;protected]</span></span>
												</span>
											</a>				
										</div>
									</div>
														...
														<ul>
															<li class="dropdown active">
																...
																<ul>
																	...
																	<li class="active"><a href="portfolio-m-grid-wide.html">Grid Wide</a></li>
																</ul>
															</li>
															<li class="dropdown">
																<a href="#">Grid View</a>
					...
					<div class="pbmit-title-bar-content-inner">
						<div class="pbmit-tbar">
							<div class="pbmit-tbar-inner container">
								<h1 class="pbmit-tbar-title"> M Grid Wide</h1>
							</div>
						</div>
						<div class="pbmit-breadcrumb">
							<div class="pbmit-breadcrumb-inner">
								...
								<span class="sep"></span>
								<span><span class="post-root post post-post current-item"> M Grid Wide</span></span>
							</div>
						</div>
					</div>
				</div> 
			...
			<section class="section-lg pbmit-element-viewtype-masonry">
				<div class="container-fluid px-4">
					<div class="row pbmit-element-posts-wrapper">
						<article class="pbmit-portfolio-style-1 col-md-6 col-lg-4">
				...
				<div class="pbmit-footer-contact-area">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 col-lg-4 pbmit-footer-contact-box">
								<span><a href="https://induyst-demo.pbminfotech.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fb9894958f9a988fbb9e839a968b979ed5989496">[email&#160;protected]</a></span>
							</div>
							<div class="col-md-12 col-lg-4 pbmit-footer-contact-box">
