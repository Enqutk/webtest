...
<!-- Mirrored from induyst-demo.pbminfotech.com/html-demo/portfolio-m-grid-col-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Aug 2025 05:32:05 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>M Grid Col 3 – Induyst HTML Template</title>
								...
								<div class="pbmit-header-info ml-auto d-flex align-items-center">
									<div class="pbmit-header-info-inner">
										...
										<div class="pbmit-header-box pbmit-header-box-3">
											<a href="https://induyst-demo.pbminfotech.com/cdn-cgi/l/email-protection#a9c7c684dbccd9c5d0e9ccd1c8c4d9c5cc87cac6c4">						
												<span class="pbmit-header-box-icon">
													<i class="pbmit-induyst-icon pbmit-induyst-icon-mail"></i>
												</span>							
												<span class="pbmit-box-content">
													<span class="pbmit-header-box-title">Email address</span>
													<span class="pbmit-header-box-content"><span class="__cf_email__" data-cfemail="d0bebffda2b5a0bca990b5a8b1bda0bcb5feb3bfbd">[email&#160;protected]</span></span>
												</span>
											</a>				
										</div>
									</div>
														...
														<ul>
															<li class="dropdown active">
																...
																<ul>
																	...
																	<li class="active"><a href="portfolio-m-grid-col-3.html">Grid Col 3</a></li>
					...
					<div class="pbmit-title-bar-content-inner">
						<div class="pbmit-tbar">
							<div class="pbmit-tbar-inner container">
								<h1 class="pbmit-tbar-title"> M Grid Col 3</h1>
							</div>
						</div>
						<div class="pbmit-breadcrumb">
							<div class="pbmit-breadcrumb-inner">
								...
								<span class="sep"></span>
								<span><span class="post-root post post-post current-item"> M Grid Col 3</span></span>
							</div>
						</div>
					</div>
				</div> 
