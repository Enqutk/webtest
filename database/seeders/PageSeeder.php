...
class PageSeeder extends Seeder
{
    public function run(): void
    {
        ...
        ContentBlock::create([ 
            ...
            'subtitle' => 'About Us',
            'short_description' => "",
            'content' => 'professional consultants specializing in a wide range of civil engineering works. We provide expert services to government, non-government, and private-sector customers.',
            'display_order' => 8,
            'is_active' => true,
            'created_by' => $user->id,
            'updated_by' => $user->id,
