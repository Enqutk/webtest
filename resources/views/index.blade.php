        ...
        @php
            $heroFeatures = [
                [
                    ...
                    'description' =>
                        'Our team consists of experienced leaders recognized regionally and internationally for their expertise. We uphold the highest standards in every project.',
                    'icon' =>
                ...
                [
                    ...
                    'description' =>
                        'Getting our clients what they deserve" is our mission. We prioritize understanding your goals to ensure our services perfectly align with your vision.',
                    'icon' =>
                ...
                [
                    ...
                    'description' =>
                        'We address local development challenges using effective communication grounded in local realities. We build consensus and create feedback mechanisms for continuous monitoring and evaluation.',
                    'icon' =>
            ...
            $aboutFeatures = ['Professionalism', 'Client-Centric Approach', 'Regional Impact'];
