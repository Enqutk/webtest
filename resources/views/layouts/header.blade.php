										...
										<div class="col-md-8 col-1">
											<div class="pbmit-slider-content">
												<h5 class="pbmit-slider-subtitle transform-right-1 transform-delay-1">
													<span>Inventing & making it to happen</span>
												</h5>
								...
								<div class="container">
									<div class="row">
										<div class="col-md-8 col-1">
											<div class="pbmit-slider-content">
												<h5 class="pbmit-slider-subtitle transform-right-1 transform-delay-1">
													<span>A Client-Centric Approach</span>
												</h5>
												<h2 class="pbmit-slider-title transform-left transform-delay-2">
													<span class="first">Modernized</span> <br> <span class="second">the <span class="pbmit-global-color">World</span></span>
												</h2>
												<p class="pbmit-slider-desc"><span>At Veritas Afrika, our mission is to deliver what our clients deserve.</span></p>
												<div class="pbmit-button d-flex align-items-center">
													<div class="transform-bottom transform-delay-4">
														<a href="about-us.html" class="pbmit-btn white">
															<span class="pbmit-button-content-wrapper">
													...
													<div class="ms-4 second-btn transform-delay-5">
														<a class="pbmit-btn-style-text white" href="#">
															<span class="pbmit-button-text">Request a Consultation</span>
														</a>
													</div>
												</div>
											</div>
								...
								<div class="container">
									<div class="row">
										<div class="col-md-9 col-lg-8 col-1">
											<div class="pbmit-slider-content">
												<h5 class="pbmit-slider-subtitle transform-right-1 transform-delay-1">
													<span>Sustainable Water Infrastructure</span>
												</h5>
												<h2 class="pbmit-slider-title transform-left transform-delay-2">
													<span class="first">Constructing </span> <span class="second">the <span class="pbmit-global-color">Industry</span></span>
												</h2>
												<p class="pbmit-slider-desc"><span>We have extensive experience in designing and managing water and wastewater systems, from bulk supply and purification to sanitation networks. </span></p>
												<div class="pbmit-button d-flex align-items-center">
													<div class="transform-bottom transform-delay-4">
														<a href="about-us.html" class="pbmit-btn white">
															<span class="pbmit-button-content-wrapper">
													...
													<div class="ms-4 second-btn transform-delay-5">
														<a class="pbmit-btn-style-text white" href="#">
															<span class="pbmit-button-text">View Our Water Projects</span>
														</a>
													</div>
												</div>
											</div>
