...
<section class="hz-section hz-about" id="about">
    <div class="container">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6">
                <p class="hz-eyebrow" data-preview-field="eyebrow" {!! \App\Support\AdminPreviewAttrs::html('about', 'eyebrow', 'Edit Eyebrow') !!}>{{ $eyebrow }}</p>
                <h2 class="hz-title hz-about-title" data-preview-field="title" {!! \App\Support\AdminPreviewAttrs::html('about', 'title', 'Edit Title') !!}>{{ $title }}</h2>
                <div class="hz-lead hz-about-copy" data-preview-field="description" data-preview-html="1" {!! \App\Support\AdminPreviewAttrs::html('about', 'paragraph_1', 'Edit Description') !!}>{!! $about['description'] !!}</div>
