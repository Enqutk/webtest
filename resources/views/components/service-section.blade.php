@php
    $services = [
        [
            ...
            'description' => 'Data analysis technique that automates the creation of analytical models is machine',
        ...
        [
            ...
            'title' => 'Comprehensive Logits',
            'description' => 'Our solutions offer door-to-door services for the import & export of consumer and industrial',
            'link' => 'service-details.html',
        ...
        [
            ...
            'description' => 'High-end manufacturers are at the forefront of technological innovation, constantly developing and implementing',
            'link' => 'service-details.html',
        ...
        [
            ...
            'description' => 'Maintaining functioning is the goal of maintenance, whereas repairs seek to restore it',
            'link' => 'service-details.html',
                                ...
                                <div class="pbmit-image-wrap">
                                    <div class="pbmit-featured-img-wrapper">
                                        <div class="pbmit-featured-wrapper">
                                            <img src="{{ asset('assets/images/homepage-1/service/' . $service['image']) }}"
                                ...
                                <div class="pbmit-service-content-wrap">
                                    ...
                                    <div class="pbmit-service-btn-wrapper">
                                        <div class="pbmit-service-btn">
                                            <a class="pbmit-button-inner" href="{{ $service['link'] }}">
